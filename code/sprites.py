...
class Paddle(pygame.sprite.Sprite):
    ...
    def move(self, dt):
        ...
        self.rect.top = 0 if self.rect.top < 0 else self.rect.top  # can't escape screen
        self.rect.bottom = WINDOW_HEIGHT if self.rect.bottom > WINDOW_HEIGHT else self.rect.bottom # can't escape screen
